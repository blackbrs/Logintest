...
public class OpcionEliminarActivity extends AppCompatActivity {
    int id;
    int idpregunta;
    String descripopc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comboArea = (Spinner) findViewById(R.id.SpinnerAreaOpEliminar);
        comboPreguntas = (Spinner) findViewById(R.id.SpinnerPregEliminar);
        comboOpcion = (Spinner) findViewById(R.id.SpinnerRespuestaEliminar);
        comboPreguntas.setEnabled(false);
        btn1 = (Button) findViewById(R.id.btnEliminarRespuestas);
        btn2 = (Button) findViewById(R.id.btnFiltroOpcionEliminar);
        btn3 = (Button) findViewById(R.id.btnFiltroEliminar);
